...
final class UpdateExistingProductsJob implements ShouldQueue, ShouldBeUnique
{
    use Queueable;
    ...
    public function handle(ExistingProductUpdater $updater): void
    {
        ...
        try {
            ...
            Log::info('existing product update finished', [
            ...
            Log::error('existing product update failed', [
                'product_import_id' => $this->productImportId,
    ...
    {
        return 'catalog-update-existing-products';
    }
