...
# The robots.txt and page metadata are generated by Next.js at build time.
# Pass the public origin into this stage so production builds do not fall back
# to the local development URL.
ARG APP_URL=http://localhost:28080
ENV APP_URL=${APP_URL}
